...
\providecommand{\Trf}{\mathcal{T}}
  ...
  \textbf{O que se afirma:} esta obra constrói os seus objetos e mede-os. Cada número
  publicado tem o programa que o produziu, e cada enunciado tem a sua demonstração ---
  a bateria corre com um comando e diz o que mediu. Quem quiser conferir não precisa
  de acreditar em nada do que aqui está escrito.\end{minipage}}}
