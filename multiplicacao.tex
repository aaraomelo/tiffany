...
corpos}. \emph{Quase} tudo o que aqui se afirma está medido, com o medidor indicado --- e o que
...
\end{center}
\end{teorema}
\citado{a obstrução em dimensão $\neq 0,1,3,7$ é o teorema de Hurwitz sobre álgebras de composição.
Aqui usa-se, e \emph{não} se demonstra --- é dela que vem toda esta tabela.}
...
aponta; o cruzado responde em $1$, $3$ e $7$, e não além.
