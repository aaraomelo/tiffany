...
- **[O ramo que nunca corre](feedback-o-ramo-que-nunca-corre.md)** — mutação que sobrevive tem TRÊS causas: ramo inalcançável, guarda redundante, ou **o gume mal feito por mim** (não passa pelo sítio / forma errada / sed não casou). Verificar as três ANTES de falar do código.
