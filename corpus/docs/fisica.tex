...
% corpus/docs/fisica.tex — O LUGAR DA FÍSICA: leis -> derivação -> observável -> teste.
...
Uma quantidade física entra aqui por uma porta só. As oito leis (\code{corpo\_analitico sub:oitoleis}) dão,
...
do Corolário da incerteza (\code{corpo\_analitico cor:incerteza}): o presente decide-se, resíduo $0$.
\end{corolario}
...
salto $\mathbb{Q}\to\mathbb{R}$ dos tecidos, onde a régua muda num degrau só (\code{corpo\_analitico
