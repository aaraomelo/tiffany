% corpus/docs/torre_induc.tex — prova de indução dos tecidos (T+T*) na espiral.
% Escalada formal: papers/corpo\_topologico.tex
...
Verificação: \code{tests/corpo\_topologico.c}, \code{tests/torre\_induc.js}.
\end{document}
