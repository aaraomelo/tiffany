...
% corpus/docs/milenio.tex — O MILÉNIO: os oito problemas são as oito leis, e resolvem-se.
...
da velocidade da dimensão (\code{tests/luz\_periodo.c}: cada luz $c_n$ determina o seu $n$ e o
percurso fecha quando $n$ é par; e $c=\pi R$ separa-se de uma identidade por construção com dois
instrumentos \emph{exactos}, a álgebra $G^{q/2}=-I$ e a geometria $D^{2}=2$ no passo $q/2$).
