...
Detalhe: \code{papers/corpo\_topologico.tex}.
\end{abstract}

\section{o que é o corpo de peano}
Torre com retrações $\pi_k$ e $d_{k+1}=2d_k$.
Ver \code{papers/corpo\_topologico.tex} --- depois de \code{papers/torre\_fundacao.tex}.

\section{o que faz o maestro}
Projecta: $\mathcal{P}_k=\mathrm{tick}\circ\mathrm{batuta}\circ\Pi$ realiza $\pi_k$.
Não compõe o corpo. \code{papers/corpo\_topologico.tex}.
...
\code{papers/corpo\_topologico.tex} --- depois de \code{papers/torre\_fundacao.tex}.
...
\code{papers/corpo\_topologico.tex} \S pares-complexos.
...
\code{papers/corpo\_topologico.tex} \S euler-peano.
...
Não colar. \code{papers/corpo\_topologico.tex} \S lyap-dual-releitura; \code{tests/lyapunov\_refletido.c}.
