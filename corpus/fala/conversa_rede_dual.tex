...
Detalhe: \code{papers/corpo\_topologico.tex} \S rede-dual.
...
\code{papers/corpo\_topologico.tex} \S rede-dual; \code{tests/rede\_dual.js} §R5--§R7.
...
\code{papers/corpo\_topologico.tex} thm:retencao-neural.
...
\code{papers/corpo\_topologico.tex}; UI \code{app/src/assistente.js}.

\section{mostra a rede dual}
\code{papers/corpo\_topologico.tex} \S rede-dual --- depois histerese e leitura complexa.
...
Prop.\ fecho experimental em \code{papers/corpo\_topologico.tex}).
...
\code{papers/corpo\_topologico.tex} Prop.\ leitura operacional.
...
\code{papers/corpo\_topologico.tex}; \code{teoria.tex} \S central.
...
\code{papers/corpo\_topologico.tex} Prop.\ central-operacional.
...
\code{papers/corpo\_topologico.tex} \S musica.
...
\code{papers/corpo\_topologico.tex} Prop.\ rede-no-canal.
...
\code{papers/corpo\_topologico.tex} Def.\ partitura; \code{corpus/docs/partitura.tex}.
...
\code{app/src/maestro.js}; Prop.\ pi-cadeia em \code{papers/corpo\_topologico.tex}.

\section{mostra a partitura}
\code{corpus/docs/partitura.tex} --- realização gráfica; produto
