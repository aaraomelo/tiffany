...
baratos: o livro já os afirma quase nas mesmas palavras. \pt{6} é postulado de
fechamento da arquitectura (\code{papers/redes.tex}): autoriza
$X\times X\to X$ e identifica $C$ com Hebb; aqui lê-se na §\ref{mf:outro}.
...
\pt{6} fecha $X\times X\to X$; interferência segue (\code{fis:thm:interfere}) \\
...
conteúdo da representação. Donde os invariantes não autorizam a passagem
$X\times X\to X$:
\[
...
\]
\pt{6} é o decreto de fechamento; não se mede, avalia-se contra ele.
...
\noindent Aqui \pt{6} lê-se nesta secção (no pipe da rede, é o postulado de
\code{papers/redes.tex}). Dela sai o mecanismo que o livro não tem para uma
palavra que ele usa muito: \cury{inevitável}.
