...
aprende "a energia do cristal" "E = soma dos quadrados — a massa da cruz; E(fonte)=E(reconstrução)=38731623179 exato; Parseval dourado 1D/2D/4D fator 256. tests/cristal_energia.js"
