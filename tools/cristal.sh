...
aprende "a perturbacao do cristal" "Apagar conceito, trocar resposta, alterar categoria, corromper projeção: R diferente de 0, REOPEN. Reordenar sobrevive por desenho (ordem canónica é derivada do id)."
