...
aprende "mostra o cristal" "cristal/cristal.jsonl — 4234 conceitos (4286 recuperados do broca-so, 52 fusões de curadoria); projeções em papers/cristal_*.tex; volta em tests/cristal_volta.js"
...
aprende "o que e meta-inducao" "O passo sobre os passos: a leitura dual que mede a indução e valida a conservação de energia. corpo_peano.tex def:inducao"
aprende "o estresse do cristal" "e = R - k, lido pelo endereço: zero exato com o endereço vivo; o par faltante+excedente quando morre. tools/lyapunov_measure.js; Teorema da Absorção, papers/corpo_peano.tex"
