...
check "o que faz o maestro" "projecta|π|tick|batuta|corpo_topologico|Maestro|maestro"
check "o que faz o metronomo" "volta|λ|atesta|Metr|metr|resíduo|residuo|corpo_topologico"
check "o que e histerese aqui" "borda|batuta|I|histerese|Lei|memória|memoria"
check "o que é o corpo de peano" "torre|π|peano|Peano|corpo_topologico|retra"
check "o que e a rede dual" "rede|Hopfield|estaca|conjug|P|banda|corpo_topologico|W="
check "o que e a conjugacao reversivel" "F_H|conjug|D|Hopfield|invers|corpo_topologico"
check "o que e o estado hibrido" "X=|hibr|híbr|\\(x|estado|F:|corpo_topologico"
...
check "o que e o teorema central no peano" "Hurwitz|Gentil|estrela|contar|integrar|central|corpo_topologico"
check "como o teorema central sobe a torre" "π|pi_k|Maestro|Metr|controlo|rede|torre|Conserv|Batuta|corpo_topologico"
check "o que e o conservatorio no peano" "Conserv|conserv|Gentil|cone|orquestra|corpo_topologico|musica"
check "como a rede dual entra na musica" "Batuta|batuta|I|rede|Metr|lambda|λ|ℱ|F:|Π|Pi|partitura|corpo_topologico"
check "o que e a partitura pi" "partitura|Π|Pi|assinatura|nota|Maestro|transporte|corpo_topologico|partitura.tex"
