...
if not errorlevel 1 (
  ...
  echo [test_cadeia] orbitas_hopfield...
  node tests\orbitas_hopfield.js || exit /b 1
  ...
  echo [test_cadeia] interface_padrao...
  node tests\interface_padrao.js || exit /b 1
  echo [test_cadeia] celula_browser...
  node tests\celula_browser.js || exit /b 1
  echo [test_cadeia] traduz_asm_wasm.js...
  node tests\traduz_asm_wasm.js || exit /b 1
) else (
