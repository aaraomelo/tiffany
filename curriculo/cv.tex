...
\textbf{não apaga um bit} --- $0$ contra $25{,}6$ milhões na forma destrutiva, medido. Ordenar e
cortar mostram-se duais, e o corte constrói-se por uma rotação de meia volta.

\section*{Pesquisa (documentação pública)}

Três volumes abertos (Teoria 60\,pp.\ · Catálogo 457\,pp.\ · narrativa 365\,pp.):
...
\textbf{Enredo} conta a mesma estrutura sem uma fórmula. Resultado actual: 60 + 457 + 365\,pp.,
...
\begin{itemize}
\item \textbf{Teoria} (60\,pp.) --- 21 enunciados e 21 provas; uma definição (corpo dual).
...
Formalismo e máquina já correm. Modelo da liga em \texttt{tests/liga.c} e Headjack em
...
IME-USP, e é hoje 60 + 457 + 365\,pp., 328 testes a zero e seis sistemas.
...
\begin{itemize}
\item \textbf{Teoria} (60\,pp.) --- 21 enunciados e 21 provas; uma definição --- o corpo dual.
