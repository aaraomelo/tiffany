...
\textbf{Remota:} Proprietário — licença comercial sob contrato.
...
\\[3pt]
{\footnotesize\color{cinza}Proprietário — contrato e pagamento (LICENSE)}
\end{center}
...
\item \textbf{Remota:} Proprietário — licença comercial sob contrato.
\end{itemize}
