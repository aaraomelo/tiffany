...
\textbf{Enredo} conta a mesma estrutura sem uma fórmula. Resultado actual: 58 + 446 + 360\,pp.,
306 testes a zero, seis sistemas. Procuro parceiros onde ainda não corre sozinho.
...
\textbf{medido} &
306 testes em C; a bateria sai a zero &
...
\item \textbf{Catálogo} (446\,pp.) --- bestiário: cada corpo com a sua régua e a sua dinâmica;
medidores citados nominalmente. É o \emph{embaixo}: onde afirmação e narrativa se encontram
e se medem.
\item \textbf{Enredo} (360\,pp.) --- a mesma estrutura como mito de xadrez: Cristal (23 lances)
...
360\,pp., $\sim$30 partes, $\sim$150 capítulos; GDD no catálogo. Vitória: o \emph{mate que
