...
\begin{itemize}
\item \textbf{Bateria de verificação} --- 307 testes em C a zero; CI bloqueia publicação se falhar.
...
Três volumes abertos (Teoria 58\,pp.\ · Catálogo 449\,pp.\ · narrativa 365\,pp.):
...
\textbf{Enredo} conta a mesma estrutura sem uma fórmula. Resultado actual: 58 + 449 + 365\,pp.,
307 testes a zero, seis sistemas. Procuro parceiros onde ainda não corre sozinho.
...
\textbf{medido} &
307 testes em C; a bateria sai a zero &
...
\begin{itemize}
\item \textbf{Teoria} (58\,pp.) --- 21 enunciados e 21 provas; uma definição (corpo dual).
\item \textbf{Catálogo} (449\,pp.) --- bestiário: cada corpo com a sua régua e a sua dinâmica;
...
\item \textbf{307 medidores em C} --- 307 verdes, 0 falhas; 115 só com aritmética inteira.
\end{itemize}
...
Formalismo e máquina já correm; modelo da liga em \texttt{tests/liga.c}; Headjack medido
em \texttt{tests/headjack.c} (campo, núcleo do operador, limites do que se vê).
\\[1pt]
...
IME-USP, e é hoje 58 + 449 + 365\,pp., 307 testes a zero e seis sistemas.
...
\textbf{medido} &
307 medidores em C; a bateria sai a zero &
...
\item \textbf{Catálogo} (449\,pp.) --- corpos um a um; medidores citados; GDD do reino;
