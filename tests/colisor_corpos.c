...
typedef struct { const char *nome; int p, q, r; } Corpo;

/* as assinaturas como o catalogo as declara (catalogo.tex, a lista dos corpos) */
static const Corpo CORPOS[] = {
    {"deflexivo",       1,0,0}, {"reflexivo",     2,0,0}, {"expansivo",     1,1,0},
    {"celeste",         2,0,0}, {"optico",        2,0,0}, {"cristalino",    2,0,0},
    {"relogio",         1,1,0}, {"sensitivo",     1,1,0}, {"evolutivo",     1,1,0},
    {"individual",      2,0,0}, {"telescopico",   2,2,0}, {"geometrico",    1,3,0},
