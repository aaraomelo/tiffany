...
\sigma^{-1/2}<1$ --- para todo $m\geq1$. É por isso que o número plástico é de Pisot: por esta
razão, não por excepção. De $n=4$ em diante a conservação deixa de decidir, porque dá o produto e
não cada fator.
...
$\sigma\nu(\sigma) = -1$). Até os degenerados coincidem: $p=2$ ramifica em $\Z[i]$ e as raízes de
