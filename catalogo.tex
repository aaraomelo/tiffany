...
\emph{E o que não se confirma, dito com número:} a espiral. O raio (peso de Hamming) \textbf{não é
monótono} --- desce em $7$ dos $15$ passos --- logo o caminho não é espiral: é um ciclo fechado, e
uma espiral fechada é um ciclo. E os pontos médios são centros de \textbf{aresta} ($15$ em $15$, uma
coordenada a $\tfrac12$) e não de face (\textbf{zero} em quinze). Se a espiral dos centros existir, é
outro caminho que não o de Gray --- e para a medir seria preciso dizer qual.
