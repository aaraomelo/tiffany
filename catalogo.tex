...
\emph{A terceira que eu afirmei é FALSA.} Escrevi que $\sigma$ é sempre de Pisot e que daí $\R^n$
mergulha em $\R$. Não é: para $m=1$ falha a partir de $n=5$, e o contraexemplo \textbf{já estava
neste projeto} --- a fatoração $x^5-x^4-1 = (x^2-x+1)(x^3-x-1)$ que a teoria usa a propósito do
Penrose. O fator $\Phi_6$ tem raízes \emph{sobre} a circunferência unitária; para $n\geq6$ o segundo
módulo passa de $1$ ($1{,}0328$, $1{,}0518$, \ldots). E nesses casos $\beta$ é redutível, logo
$\Q[x]/(\beta)$ \textbf{não é corpo}.
