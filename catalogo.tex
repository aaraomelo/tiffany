...
\textbf{Sessenta e seis pares} projetados sobre o que este capítulo mede --- o telómero, a
transformada, o $+1$, o barramento, a lei da simetria, os medidores todos, e os erros que eles
apanharam. E o que a cifra usa não são os pesos de ninguém: é o \textbf{espaço semântico}, que é o
do \code{nomic}.

Medido: posto \emph{cheio} (todos independentes, nenhum é combinação dos outros), cosseno médio
$0{,}5704$ entre pares --- \emph{dezasseis vezes o acaso}, e é isso o significado --- e a cifra na
base própria devolve os vetores com resíduo $6{,}1\times10^{-15}$, com as \textbf{distâncias
preservadas} a $1{,}9\times10^{-15}$.

\emph{E o crescimento não degradou nada:} de $16$ para $66$ pares, o cosseno médio mexeu-se de
$0{,}5757$ para $0{,}5704$ e o resíduo manteve-se na casa do epsilon. \textbf{Crescer o tecido não
custa reversibilidade} --- é o que a ortonormalidade da base garante, e por isso ``reversível sempre
vai ser'' não é uma esperança: é uma consequência.
