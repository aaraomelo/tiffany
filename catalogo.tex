...
Fecha com a \textbf{distributiva} ($\otimes$ sobre $\oplus$), que faz do corpo de corpos um
semianel, e com o controlo: a lei recíproca é falsa ($14 \neq 30$) e o mesmo critério reprova-a.
\emph{E um bug meu que a asserção apanhou:} limpava a matriz só até $ns\times ns$ e contava a ordem
varrendo até $16$ --- o lixo da iteração anterior inflava a contagem. Oito asserções, zero falhas.
