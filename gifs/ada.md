# ada — Descrição Matemática e Script GLSL

## Card
`ada` — 6s, 24fps, 640×640 (gravado em `gifs/ada_6s_24fps.gif`)

## Equação aplicada

$$parte do círculo · revela o atrator (n=2)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do ada aplica:

```glsl
// ada: parte do círculo · revela o atrator (n=2)
...
- gifs/ada_6s_24fps.gif — GIF gravado
