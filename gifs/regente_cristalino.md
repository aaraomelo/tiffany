# regente_cristalino — Descrição Matemática e Script GLSL

## Card
`regente_cristalino` — 6s, 24fps, 640×640 (gravado em `gifs/regente_cristalino_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do regente_cristalino aplica:

```glsl
// regente_cristalino: simetria de ordem 6
...
- gifs/regente_cristalino_6s_24fps.gif — GIF gravado
