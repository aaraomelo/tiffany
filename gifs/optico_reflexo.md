# optico_reflexo — Descrição Matemática e Script GLSL

## Card
`optico_reflexo` — 6s, 24fps, 640×640 (gravado em `gifs/optico_reflexo_6s_24fps.gif`)

## Equação aplicada

$$R = V − 2(V·n)n · céu(R) · Fresnel$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do optico_reflexo aplica:

```glsl
// optico_reflexo: R = V − 2(V·n)n · céu(R) · Fresnel
...
- gifs/optico_reflexo_6s_24fps.gif — GIF gravado
