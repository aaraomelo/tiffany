# opt_rainha_tiffany — Descrição Matemática e Script GLSL

## Card
`opt_rainha_tiffany` — 6s, 24fps, 640×640 (gravado em `gifs/opt_rainha_tiffany_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_rainha_tiffany aplica:

```glsl
// opt_rainha_tiffany: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_rainha_tiffany_6s_24fps.gif — GIF gravado
