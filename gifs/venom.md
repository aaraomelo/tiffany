# venom — Descrição Matemática e Script GLSL

## Card
`venom` — 6s, 24fps, 640×640 (gravado em `gifs/venom_6s_24fps.gif`)

## Equação aplicada

$$o gás negro — a expansão de de Sitter (o tabuleiro cósmico)$$

## Técnica
venom_rev — a expansão de de Sitter

## Script GLSL Aplicado

O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do venom aplica:

```glsl
// venom: o gás negro — a expansão de de Sitter (o tabuleiro cósmico)
...
- gifs/venom_6s_24fps.gif — GIF gravado
