# alonzo — Descrição Matemática e Script GLSL

## Card
`alonzo` — 6s, 24fps, 640×640 (gravado em `gifs/alonzo_6s_24fps.gif`)

## Equação aplicada

$$parte do círculo · revela o atrator (n=3)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do alonzo aplica:

```glsl
// alonzo: parte do círculo · revela o atrator (n=3)
...
- gifs/alonzo_6s_24fps.gif — GIF gravado
