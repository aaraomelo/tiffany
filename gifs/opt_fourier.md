# opt_fourier — Descrição Matemática e Script GLSL

## Card
`opt_fourier` — 6s, 24fps, 640×640 (gravado em `gifs/opt_fourier_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_fourier aplica:

```glsl
// opt_fourier: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_fourier_6s_24fps.gif — GIF gravado
