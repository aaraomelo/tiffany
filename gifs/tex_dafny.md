# tex_dafny — Descrição Matemática e Script GLSL

## Card
`tex_dafny` — 6s, 24fps, 640×640 (gravado em `gifs/tex_dafny_6s_24fps.gif`)

## Equação aplicada

$$cos 4(θ−γ) · as 4 pontas nas 4 pétalas$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_dafny aplica:

```glsl
// tex_dafny: cos 4(θ−γ) · as 4 pontas nas 4 pétalas
...
- gifs/tex_dafny_6s_24fps.gif — GIF gravado
