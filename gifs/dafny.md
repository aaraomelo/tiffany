# dafny — Descrição Matemática e Script GLSL

## Card
`dafny` — 6s, 24fps, 640×640 (gravado em `gifs/dafny_6s_24fps.gif`)

## Equação aplicada

$$decide o decidível · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do dafny aplica:

```glsl
// dafny: decide o decidível · revela o atrator
...
- gifs/dafny_6s_24fps.gif — GIF gravado
