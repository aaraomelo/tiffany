# aurea_mae — Descrição Matemática e Script GLSL

## Card
`aurea_mae` — 6s, 24fps, 640×640 (gravado em `gifs/aurea_mae_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do aurea_mae aplica:

```glsl
// aurea_mae: r = φ^(2θ/π) · 2 braços
...
- gifs/aurea_mae_6s_24fps.gif — GIF gravado
