# opt_dark_pontryagin — Descrição Matemática e Script GLSL

## Card
`opt_dark_pontryagin` — 6s, 24fps, 640×640 (gravado em `gifs/opt_dark_pontryagin_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_dark_pontryagin aplica:

```glsl
// opt_dark_pontryagin: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_dark_pontryagin_6s_24fps.gif — GIF gravado
