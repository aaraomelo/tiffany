# rei_cifra_textura — Descrição Matemática e Script GLSL

## Card
`rei_cifra_textura` — 6s, 24fps, 640×640 (gravado em `gifs/rei_cifra_textura_6s_24fps.gif`)

## Equação aplicada

$$û=p/|p| (Clifford ⊕) → estereográfica → a cifra radial$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do rei_cifra_textura aplica:

```glsl
// rei_cifra_textura: û=p/|p| (Clifford ⊕) → estereográfica → a cifra radial
...
- gifs/rei_cifra_textura_6s_24fps.gif — GIF gravado
