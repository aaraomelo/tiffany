# armadura_universal — Descrição Matemática e Script GLSL

## Card
`armadura_universal` — 6s, 24fps, 640×640 (gravado em `gifs/armadura_universal_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do armadura_universal aplica:

```glsl
// armadura_universal: log(ab)=log a+log b
...
- gifs/armadura_universal_6s_24fps.gif — GIF gravado
