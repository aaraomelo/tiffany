# rei_cifra — Descrição Matemática e Script GLSL

## Card
`rei_cifra` — 6s, 24fps, 640×640 (gravado em `gifs/rei_cifra_6s_24fps.gif`)

## Equação aplicada

$$σ\_m = m + 1/σ\_m  (o ponto fixo)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do rei_cifra aplica:

```glsl
// rei_cifra: σ_m = m + 1/σ_m  (o ponto fixo)
...
- gifs/rei_cifra_6s_24fps.gif — GIF gravado
