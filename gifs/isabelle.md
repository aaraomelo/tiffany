# isabelle — Descrição Matemática e Script GLSL

## Card
`isabelle` — 6s, 24fps, 640×640 (gravado em `gifs/isabelle_6s_24fps.gif`)

## Equação aplicada

$$constrói o infinito · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do isabelle aplica:

```glsl
// isabelle: constrói o infinito · revela o atrator
...
- gifs/isabelle_6s_24fps.gif — GIF gravado
