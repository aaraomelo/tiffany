# rainha_textura — Descrição Matemática e Script GLSL

## Card
`rainha_textura` — 6s, 24fps, 640×640 (gravado em `gifs/rainha_textura_6s_24fps.gif`)

## Equação aplicada

$$û=p/|p| (Clifford ⊕) ⋈ cos 6(θ−γ) (La Hire ⊗) ⋈ γ comum (Pontryagin)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do rainha_textura aplica:

```glsl
// rainha_textura: û=p/|p| (Clifford ⊕) ⋈ cos 6(θ−γ) (La Hire ⊗) ⋈ γ comum (Pontryagin)
...
- gifs/rainha_textura_6s_24fps.gif — GIF gravado
