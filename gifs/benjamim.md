# benjamim — Descrição Matemática e Script GLSL

## Card
`benjamim` — 6s, 24fps, 640×640 (gravado em `gifs/benjamim_6s_24fps.gif`)

## Equação aplicada

$$∏ = exp ∘ Σ ∘ log · revela o atrator$$
...
```glsl
// benjamim: ∏ = exp ∘ Σ ∘ log · revela o atrator
...
- gifs/benjamim_6s_24fps.gif — GIF gravado
