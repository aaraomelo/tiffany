# optico_completo — Descrição Matemática e Script GLSL

## Card
`optico_completo` — 6s, 24fps, 640×640 (gravado em `gifs/optico_completo_6s_24fps.gif`)

## Equação aplicada

$$difuso + especular · AO · sombra + Fresnel + reflexão$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do optico_completo aplica:

```glsl
// optico_completo: difuso + especular · AO · sombra + Fresnel + reflexão
...
- gifs/optico_completo_6s_24fps.gif — GIF gravado
