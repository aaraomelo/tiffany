# fourier — Descrição Matemática e Script GLSL

## Card
`fourier` — 6s, 24fps, 640×640 (gravado em `gifs/fourier_6s_24fps.gif`)

## Equação aplicada

$$as ondas · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do fourier aplica:

```glsl
// fourier: as ondas · revela o atrator
...
- gifs/fourier_6s_24fps.gif — GIF gravado
