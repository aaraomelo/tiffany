# penny — Descrição Matemática e Script GLSL

## Card
`penny` — 6s, 24fps, 640×640 (gravado em `gifs/penny_6s_24fps.gif`)

## Equação aplicada

$$parte do círculo · revela o atrator (n=5)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do penny aplica:

```glsl
// penny: parte do círculo · revela o atrator (n=5)
...
- gifs/penny_6s_24fps.gif — GIF gravado
