# rainha_tiffany — Descrição Matemática e Script GLSL

## Card
`rainha_tiffany` — 6s, 24fps, 640×640 (gravado em `gifs/rainha_tiffany_6s_24fps.gif`)

## Equação aplicada

$$φ² = φ + 1  (a soma = o produto)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do rainha_tiffany aplica:

```glsl
// rainha_tiffany: φ² = φ + 1  (a soma = o produto)
...
- gifs/rainha_tiffany_6s_24fps.gif — GIF gravado
