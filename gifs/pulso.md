# pulso — Descrição Matemática e Script GLSL

## Card
`pulso` — 6s, 24fps, 640×640 (gravado em `gifs/pulso_6s_24fps.gif`)

## Equação aplicada

$$a exp que bate ⋈ a espiral que gira$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do pulso aplica:

```glsl
// pulso: a exp que bate ⋈ a espiral que gira
...
- gifs/pulso_6s_24fps.gif — GIF gravado
