# combinacao — Descrição Matemática e Script GLSL

## Card
`combinacao` — 6s, 24fps, 640×640 (gravado em `gifs/combinacao_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do combinacao aplica:

```glsl
// combinacao: r = φ^(2θ/π) · 8 braços
...
- gifs/combinacao_6s_24fps.gif — GIF gravado
