# continuo — Descrição Matemática e Script GLSL

## Card
`continuo` — 6s, 24fps, 640×640 (gravado em `gifs/continuo_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do continuo aplica:

```glsl
// continuo: r = φ^(2θ/π) · 5 braços
...
- gifs/continuo_6s_24fps.gif — GIF gravado
