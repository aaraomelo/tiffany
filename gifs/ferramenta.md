# ferramenta — Descrição Matemática e Script GLSL

## Card
`ferramenta` — 6s, 24fps, 640×640 (gravado em `gifs/ferramenta_6s_24fps.gif`)

## Equação aplicada

$$resíduo 0 (as duas metades)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do ferramenta aplica:

```glsl
// ferramenta: resíduo 0 (as duas metades)
...
- gifs/ferramenta_6s_24fps.gif — GIF gravado
