# ferramenta_meia — Descrição Matemática e Script GLSL

## Card
`ferramenta_meia` — 6s, 24fps, 640×640 (gravado em `gifs/ferramenta_meia_6s_24fps.gif`)

## Equação aplicada

$$resíduo ≠ 0 (falta um lado)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do ferramenta_meia aplica:

```glsl
// ferramenta_meia: resíduo ≠ 0 (falta um lado)
...
- gifs/ferramenta_meia_6s_24fps.gif — GIF gravado
