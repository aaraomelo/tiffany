# tex_benjamim — Descrição Matemática e Script GLSL

## Card
`tex_benjamim` — 6s, 24fps, 640×640 (gravado em `gifs/tex_benjamim_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_benjamim aplica:

```glsl
// tex_benjamim: cos 3(θ−γ) · as 3 pontas nas 3 pétalas
...
- gifs/tex_benjamim_6s_24fps.gif — GIF gravado
