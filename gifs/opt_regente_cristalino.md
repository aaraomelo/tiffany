# opt_regente_cristalino — Descrição Matemática e Script GLSL

## Card
`opt_regente_cristalino` — 6s, 24fps, 640×640 (gravado em `gifs/opt_regente_cristalino_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_regente_cristalino aplica:

```glsl
// opt_regente_cristalino: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_regente_cristalino_6s_24fps.gif — GIF gravado
