# opt_isabelle — Descrição Matemática e Script GLSL

## Card
`opt_isabelle` — 6s, 24fps, 640×640 (gravado em `gifs/opt_isabelle_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_isabelle aplica:

```glsl
// opt_isabelle: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_isabelle_6s_24fps.gif — GIF gravado
