# tex_dark_pontryagin — Descrição Matemática e Script GLSL

## Card
`tex_dark_pontryagin` — 6s, 24fps, 640×640 (gravado em `gifs/tex_dark_pontryagin_6s_24fps.gif`)

## Equação aplicada

$$cos 3(θ−γ) · as 3 pontas nas 3 pétalas$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_dark_pontryagin aplica:

```glsl
// tex_dark_pontryagin: cos 3(θ−γ) · as 3 pontas nas 3 pétalas
...
- gifs/tex_dark_pontryagin_6s_24fps.gif — GIF gravado
