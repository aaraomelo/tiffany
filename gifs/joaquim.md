# joaquim — Descrição Matemática e Script GLSL

## Card
`joaquim` — 6s, 24fps, 640×640 (gravado em `gifs/joaquim_6s_24fps.gif`)

## Equação aplicada

$$⊕  (a soma, o momentum) · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do joaquim aplica:

```glsl
// joaquim: ⊕  (a soma, o momentum) · revela o atrator
...
- gifs/joaquim_6s_24fps.gif — GIF gravado
