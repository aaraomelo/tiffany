# tex_regente_cristalino — Descrição Matemática e Script GLSL

## Card
`tex_regente_cristalino` — 6s, 24fps, 640×640 (gravado em `gifs/tex_regente_cristalino_6s_24fps.gif`)

## Equação aplicada

$$cos 6(θ−γ) · as 6 pontas nas 6 pétalas$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_regente_cristalino aplica:

```glsl
// tex_regente_cristalino: cos 6(θ−γ) · as 6 pontas nas 6 pétalas
...
- gifs/tex_regente_cristalino_6s_24fps.gif — GIF gravado
