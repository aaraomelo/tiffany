# cifra_ouro — Descrição Matemática e Script GLSL

## Card
`cifra_ouro` — 6s, 24fps, 640×640 (gravado em `gifs/cifra_ouro_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do cifra_ouro aplica:

```glsl
// cifra_ouro: cresce por φ  (σ₁=φ)
...
- gifs/cifra_ouro_6s_24fps.gif — GIF gravado
