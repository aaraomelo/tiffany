# dark_pontryagin — Descrição Matemática e Script GLSL

## Card
`dark_pontryagin` — 6s, 24fps, 640×640 (gravado em `gifs/dark_pontryagin_6s_24fps.gif`)

## Equação aplicada

$$σ\_m' = −1/σ\_m · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do dark_pontryagin aplica:

```glsl
// dark_pontryagin: σ_m' = −1/σ_m · revela o atrator
...
- gifs/dark_pontryagin_6s_24fps.gif — GIF gravado
