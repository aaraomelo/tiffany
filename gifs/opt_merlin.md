# opt_merlin — Descrição Matemática e Script GLSL

## Card
`opt_merlin` — 6s, 24fps, 640×640 (gravado em `gifs/opt_merlin_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_merlin aplica:

```glsl
// opt_merlin: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_merlin_6s_24fps.gif — GIF gravado
