# opt_ada — Descrição Matemática e Script GLSL

## Card
`opt_ada` — 6s, 24fps, 640×640 (gravado em `gifs/opt_ada_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_ada aplica:

```glsl
// opt_ada: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_ada_6s_24fps.gif — GIF gravado
