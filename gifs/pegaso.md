# pegaso — Descrição Matemática e Script GLSL

## Card
`pegaso` — 6s, 24fps, 640×640 (gravado em `gifs/pegaso_6s_24fps.gif`)

## Equação aplicada

$$o rotor · s²+c²=1 · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do pegaso aplica:

```glsl
// pegaso: o rotor · s²+c²=1 · revela o atrator
...
- gifs/pegaso_6s_24fps.gif — GIF gravado
