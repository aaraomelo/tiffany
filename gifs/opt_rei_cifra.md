# opt_rei_cifra — Descrição Matemática e Script GLSL

## Card
`opt_rei_cifra` — 6s, 24fps, 640×640 (gravado em `gifs/opt_rei_cifra_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_rei_cifra aplica:

```glsl
// opt_rei_cifra: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_rei_cifra_6s_24fps.gif — GIF gravado
