# naturais — Descrição Matemática e Script GLSL

## Card
`naturais` — 6s, 24fps, 640×640 (gravado em `gifs/naturais_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do naturais aplica:

```glsl
// naturais: r = φ^(2θ/π) · 1 braços
...
- gifs/naturais_6s_24fps.gif — GIF gravado
