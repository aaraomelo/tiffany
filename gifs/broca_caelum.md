# broca_caelum — Descrição Matemática e Script GLSL

## Card
`broca_caelum` — 6s, 24fps, 640×640 (gravado em `gifs/broca_caelum_6s_24fps.gif`)

## Equação aplicada

$$o corpo evolutivo ⊗ a espiral áurea$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do broca_caelum aplica:

```glsl
// broca_caelum: o corpo evolutivo ⊗ a espiral áurea
...
- gifs/broca_caelum_6s_24fps.gif — GIF gravado
