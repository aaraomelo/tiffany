# garrafa_koch — Descrição Matemática e Script GLSL

## Card
`garrafa_koch` — 6s, 24fps, 640×640 (gravado em `gifs/garrafa_koch_6s_24fps.gif`)

## Equação aplicada

$$perímetro ∞, área finita$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do garrafa_koch aplica:

```glsl
// garrafa_koch: perímetro ∞, área finita
...
- gifs/garrafa_koch_6s_24fps.gif — GIF gravado
