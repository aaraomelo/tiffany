# racionais — Descrição Matemática e Script GLSL

## Card
`racionais` — 6s, 24fps, 640×640 (gravado em `gifs/racionais_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do racionais aplica:

```glsl
// racionais: r = φ^(2θ/π) · 3 braços
...
- gifs/racionais_6s_24fps.gif — GIF gravado
