# triade — Descrição Matemática e Script GLSL

## Card
`triade` — 6s, 24fps, 640×640 (gravado em `gifs/triade_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do triade aplica:

```glsl
// triade: r = φ^(2θ/π) · 3 braços
...
- gifs/triade_6s_24fps.gif — GIF gravado
