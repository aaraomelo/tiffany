# opt_joaquim — Descrição Matemática e Script GLSL

## Card
`opt_joaquim` — 6s, 24fps, 640×640 (gravado em `gifs/opt_joaquim_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_joaquim aplica:

```glsl
// opt_joaquim: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_joaquim_6s_24fps.gif — GIF gravado
