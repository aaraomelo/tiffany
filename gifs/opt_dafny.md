# opt_dafny — Descrição Matemática e Script GLSL

## Card
`opt_dafny` — 6s, 24fps, 640×640 (gravado em `gifs/opt_dafny_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_dafny aplica:

```glsl
// opt_dafny: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_dafny_6s_24fps.gif — GIF gravado
