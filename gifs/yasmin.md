# yasmin — Descrição Matemática e Script GLSL

## Card
`yasmin` — 6s, 24fps, 640×640 (gravado em `gifs/yasmin_6s_24fps.gif`)

## Equação aplicada

$$⊗  (o produto, a escala) · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do yasmin aplica:

```glsl
// yasmin: ⊗  (o produto, a escala) · revela o atrator
...
- gifs/yasmin_6s_24fps.gif — GIF gravado
