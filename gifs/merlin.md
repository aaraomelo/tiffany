# merlin — Descrição Matemática e Script GLSL

## Card
`merlin` — 6s, 24fps, 640×640 (gravado em `gifs/merlin_6s_24fps.gif`)

## Equação aplicada

$$a Mellin (escala-invariante) · revela o atrator$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do merlin aplica:

```glsl
// merlin: a Mellin (escala-invariante) · revela o atrator
...
- gifs/merlin_6s_24fps.gif — GIF gravado
