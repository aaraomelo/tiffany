# tex_joaquim — Descrição Matemática e Script GLSL

## Card
`tex_joaquim` — 6s, 24fps, 640×640 (gravado em `gifs/tex_joaquim_6s_24fps.gif`)

## Equação aplicada

$$cos 2(θ−γ) · as 2 pontas nas 2 pétalas$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_joaquim aplica:

```glsl
// tex_joaquim: cos 2(θ−γ) · as 2 pontas nas 2 pétalas
...
- gifs/tex_joaquim_6s_24fps.gif — GIF gravado
