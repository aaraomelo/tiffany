# tex_isabelle — Descrição Matemática e Script GLSL

## Card
`tex_isabelle` — 6s, 24fps, 640×640 (gravado em `gifs/tex_isabelle_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_isabelle aplica:

```glsl
// tex_isabelle: cos 6(θ−γ) · as 6 pontas nas 6 pétalas
...
- gifs/tex_isabelle_6s_24fps.gif — GIF gravado
