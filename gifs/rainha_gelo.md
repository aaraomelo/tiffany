# rainha_gelo — Descrição Matemática e Script GLSL

## Card
`rainha_gelo` — 6s, 24fps, 640×640 (gravado em `gifs/rainha_gelo_6s_24fps.gif`)

## Equação aplicada

$$o campo da Rainha, revertido pelo Venom (χ = −1)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do rainha_gelo aplica:

```glsl
// rainha_gelo: o campo da Rainha, revertido pelo Venom (χ = −1)
...
- gifs/rainha_gelo_6s_24fps.gif — GIF gravado
