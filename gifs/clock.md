# clock — Descrição Matemática e Script GLSL

## Card
`clock` — 6s, 24fps, 640×640 (gravado em `gifs/clock_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do clock aplica:
...
- gifs/clock_6s_24fps.gif — GIF gravado
