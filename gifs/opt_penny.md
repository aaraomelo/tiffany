# opt_penny — Descrição Matemática e Script GLSL

## Card
`opt_penny` — 6s, 24fps, 640×640 (gravado em `gifs/opt_penny_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do opt_penny aplica:

```glsl
// opt_penny: a coroa costurada + os 6 efeitos ópticos (PBR)
...
- gifs/opt_penny_6s_24fps.gif — GIF gravado
