# tex_pegaso — Descrição Matemática e Script GLSL

## Card
`tex_pegaso` — 6s, 24fps, 640×640 (gravado em `gifs/tex_pegaso_6s_24fps.gif`)
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do tex_pegaso aplica:

```glsl
// tex_pegaso: cos 2(θ−γ) · as 2 pontas nas 2 pétalas
...
- gifs/tex_pegaso_6s_24fps.gif — GIF gravado
