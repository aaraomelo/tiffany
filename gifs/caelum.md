# caelum — Descrição Matemática e Script GLSL

## Card
`caelum` — 6s, 24fps, 640×640 (gravado em `gifs/caelum_6s_24fps.gif`)

## Equação aplicada

$$parte do círculo · revela o atrator (n=8)$$
...
O GLSL é gerado dinamicamente por `cards_kernel.js` → `cards_campo.js`. O kernel do caelum aplica:

```glsl
// caelum: parte do círculo · revela o atrator (n=8)
...
- gifs/caelum_6s_24fps.gif — GIF gravado
