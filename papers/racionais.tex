...
\mathbb{N} & \longrightarrow & \mathbb{Z}
 ...
 & \text{\code{inteiros.tex}; ponto fixo: }0\\[4pt]
...
\text{degrau anterior }\mathbb{N}\!\to\!\mathbb{Z} & \code{inteiros.tex} & \text{soma cruzada }a+d=b+c\\[6pt]
...
\text{a EQUIVALÊNCIA }$\sim$ & \text{Prop.~\ref{prop:equiv}} & $ad=bc$ antes do quociente\\[2pt]
...
(4) Soma e produto bem definidos: Prop.~\ref{prop:bemdef}.
(5) Neutro aditivo: $(0,1)\oplus(a,b)=(a,b)$; multiplicativo: $(1,1)\otimes(a,b)=(a,b)$.
(6) Oposto: $(a,b)\oplus(-a,b)\sim(0,1)$; inverso: $(a,b)\otimes(b,a)\sim(1,1)$, $a\neq 0$.
(7) Distributividade: verificação directa sobre representantes.
(8) Ordem: comparar $ad$ e $bc$ com $b,d>0$. $\square$
\end{proof}
...
migração Q em E₁₆ & §GW, §G0--§G5 & \code{tests/migracao.c} & $7/7$ \\
...
\[
\boxed{
[(a,b)]\xmapsto{\bar\iota}[(b,a)],\qquad
