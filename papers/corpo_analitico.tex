...
\text{a Lei } 1\dg=-1 & \code{algebrico thm:fixo-dual} & \text{a leitura: o que separa}\\[2pt]
\text{a Lei } T\dg=-T,\ J & \code{algebrico thm:espectro-tau} & \text{o passo: o que roda}\\[2pt]
\text{a operação }\star & \code{algebrico thm:operacao} & \text{a soma e o produto do corpo}\\[2pt]
...
%======================================================================
\section{O ALCANCE: completude, supremo, e $\pi$}\label{sec:alcance}
...
%======================================================================
\section{TODO $\mathbb{R}$, e o limite que o funda}\label{sec:todo-r}
