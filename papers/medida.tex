...
está}. E a área só se enche com o acaso, porque uma trajectória determinista é sempre uma curva, e uma
curva não pesa. É por isso que o Monte Carlo não é aqui uma aproximação inferior à contagem: é a
\emph{outra coordenada} da medida, a que o furo (\S\ref{sec:furar}) obriga.
...
a convergir; e o par: a curva determinista cobre $1/N\to0$ (medida zero) e o rasto aleatório cobre
