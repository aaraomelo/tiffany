...
(5) $(\mathbb{Z},+,\cdot)$ é anel. Como $\Phi$ é bijecção e
$\Phi(x\oplus y)=\Phi(x)+\Phi(y)$,
$\Phi(x\otimes y)=\Phi(x)\Phi(y)$, transportam-se os axiomas: associatividade
e comutatividade de $\oplus$ e $\otimes$, distributividade,
$[(0,0)]$ neutro de $\oplus$, $[(1,0)]$ neutro de $\otimes$,
$[(b,a)]$ oposto aditivo de $[(a,b)]$. Logo
$(V_{\mathrm{int}}/{\sim},\oplus,\otimes)$ \textbf{é} anel e $\Phi$ isomorfismo
de anéis.
