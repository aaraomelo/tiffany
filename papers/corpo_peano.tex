...
\bigskip
\noindent\textbf{Verificação.} \code{tests/corpo\_peano.c} §CP1--§CP37:
metrónomo$=$relógio musical; batuta$=$canal do inversor (não $I$);
consistência; milénios subordinados.
