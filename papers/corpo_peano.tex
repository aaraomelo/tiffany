...
realização operacional observada. O tradutor \texttt{.tex}$\leftrightarrow$PDF
...
A música é a \textbf{consequência} do Teorema do Maestro
(\S\ref{sec:maestro-thm}): a teoria constrói a retração; o maestro
realiza-a dinamicamente; a música é o resultado observado.
\[
\boxed{
\text{Conservatório}
\;\to\;
...
Música & realização do dual central \\
...
\bigskip
\noindent\textbf{Verificação.} \code{tests/corpo\_peano.c} §CP1--§CP39;
