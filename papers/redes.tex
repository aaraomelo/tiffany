...
Interface não é transporte. Memória não é fio.
...
$W_a$ ($W_a^{\top}=-W_a$) & ordem do canal --- $s^{\top}W_as=0$ & aresta $a{=}1$ \\
$a{=}1$ & aresta duo da rede de línguas & $W_a$ \\
$G{=}1$ & fita / passagem única & Hopfield \\
\code{fios} & HTTP não absorvido & órbita, $W$ \\
\bottomrule
\end{tabular}
\end{center}
