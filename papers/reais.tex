...
\medido{\code{tests/tres\_caminhos.c} §RE0--§RE11 ($12{:}0$): §RE0 $16\,200$
...
\medido{\code{tests/tres\_caminhos.c} §RE0--§RE13 ($14{:}0$, gume $2/1/1$ e $3/1$);
\code{diagonal.c} §DG0--§DG2 ($3{:}0$); \code{fractais.c} §FR0--§FR6 ($7{:}0$);
