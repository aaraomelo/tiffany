...
O determinante é o factor de escala da medida, e a passagem entre andares duais é
sigma vezes sigma linha igual a menos um — que é a mesma frase que módulo do determinante
igual a um. Determinante, medida e dualidade não são três leis: são três realizações de
uma.
