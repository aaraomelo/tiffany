...
convém não as confundir: uma acumula ao longo do tempo, a outra soma sobre o
espaço.
...
\medskip\noindent Isto não enfraquece o Teor.~\ref{thm:dimensao} --- confirma-o.
A dimensão entra num sítio único, a vizinhança; e trocar a estrutura de $X$ troca
exatamente esse número, $2n$ na grade e $1$ na árvore. Os outros três passos do
ciclo são os mesmos.
...
Teor.~\ref{thm:leitura} (dobrar sem período obriga a ler o índice)}
        {campo esparso, $\Theta(n)$/passo, memória $\Theta(|I|)$, sem alocação dinâmica;
         $\Z^1$--$\Z^4$, árvore, $\Z[i]$}
        {\code{tests/aranha\_n.c} §AN1--§AN16;
