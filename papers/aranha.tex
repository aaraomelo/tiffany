...
que o gradiente do passo~3 tem de olhar para $2n$ valores em vez de $4$. O resto
do ciclo não sabe em que dimensão está.
...
dragão de coisa nenhuma: pelo Lema~\ref{lem:conserva},
...
ciclo em $\Z^n$ e Teor.~\ref{thm:fecho} §AN13 (leitura a distinguir $G{=}0$ de
...
Teor.~\ref{thm:leitura} (dobrar sem período obriga a ler o índice)}
        {campo esparso, $O(1)$/passo, sem alocação dinâmica;
         $\Z^1$--$\Z^4$, árvore, $\Z[i]$}
        {\code{tests/aranha\_n.c} §AN1--§AN13;
