...
\begin{teorema}[a face graduada da conservação métrica --- o Jacobiano, e
a lei é LOCAL]\label{thm:medida-jacobiano}
A realização graduada da conservação métrica (\emph{Corpo Universal},
Teor.~da conservação métrica por dualidade) é a \textbf{mudança de
variável}: o determinante deixa de ser função de uma matriz e passa a
...
Teor.~da face discreta (\emph{Corpo de Peano}) o factor é \emph{um}
...
\textbf{(2) E a ausência de tecto é da forma, não da varredura.} A base
é $\det(I)=1$; o passo é
...
$11{:}0$): $|\det DT|=1$ em $100$ pontos racionais com a derivada a
...
do \emph{Corpo de Peano} ($\ker\partial/\operatorname{im}\partial$,
