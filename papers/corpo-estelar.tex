...
\subsection*{E o corte é a massa do corpo na borda}
...
\]
e \textbf{as duas são função do mesmo desequilíbrio}. Ambas são máximas onde ele é \emph{zero} ---
na \textbf{borda}, onde $|A|=|B|$. Logo \textbf{maximizar o corte é maximizar a massa}.
...
máximo no \emph{mesmo} argumento em três escalas, e esse argumento é a borda; e o \textbf{controlo}:
...
o max-cut & $|A||B|$ e $\sum(x-c)^2$ & \textbf{a mesma quantidade}: a massa na borda \\
\bottomrule
\end{tabular}
\end{center}
