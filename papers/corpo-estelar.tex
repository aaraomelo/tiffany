...
\smallskip
\noindent \textbf{E a massa é vectorial, não escalar.} Em $\mathbb{R}^n$ a segunda coordenada da cruz
não é um número: é a \emph{matriz}
\[
  M_{ij} = \sum (x_i-c_i)(x_j-c_j) ,
\]
e a massa escalar é apenas o seu \textbf{traço}. Logo \emph{a massa tem direcção} --- um corpo pode
ter massa diferente em eixos diferentes, e o número não o vê. E mede-se pelo que se perde: de $168$
