...
\smallskip
\noindent \textbf{E a massa é vectorial porque é um corpo.} Um corpo é uma \emph{n}-upla --- não há
aqui um número a que se acrescenta direcção, há uma \emph{n}-upla desde o início, e o escalar é uma
\textbf{projecção} dela. Perguntar porque é que a massa tem direcção é perguntar porque é que um
corpo tem componentes: tem-nas por ser corpo. Em $\mathbb{R}^n$ a segunda coordenada da cruz não é um
número: é a \emph{matriz}
\[
