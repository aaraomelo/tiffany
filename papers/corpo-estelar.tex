...
argumento habitual, de que $c^2$ traz velocidade ao quadrado, aqui \emph{não vale}. O que os separa é
...
\noindent \textbf{Fica $E=mc^2$, mas não pela razão habitual: pela volta.} O que sobrevive é o que
fecha, e meia volta não fecha.

\medido{a dimensão \emph{não} separa $mc$ de $mc^2$ nas quatro roupas, porque $\sigma$ é puro; uma
passagem pela régua deixa resíduo em $220$ casos e a ida-e-volta deixa \emph{zero}; $E=m$ em p.u.\ com resíduo $0$ em $41$ massas; $\sigma^j=F_j\sigma+F_{j-1}$ em $72$ potências
