...
O Metrônome lê dados a partir do arquivo corpo\_peano.tex. Ele calcula e apresenta os primeiros termos da sequência Peano, que são essenciais para entender algumas propriedades fundamentais da teoria de números. Sempre está preparado para receber as entradas necessárias para continuar o cálculo.
