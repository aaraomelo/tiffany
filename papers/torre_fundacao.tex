...
% papers/torre_fundacao.tex — Quatro fundações ANTES do Corpo de Peano.
...
\emph{Corpo de Peano} (\code{papers/corpo\_peano.tex}), no Teorema
...
\end{itemize}
Esses objectos vivem em \code{papers/corpo\_peano.tex} e só fazem
...
(\code{papers/conversa.tex}, \code{tools/vizinhanca.sh}).
...
\code{papers/corpo\_peano.tex} $\to$
\code{papers/partitura.tex} / \code{papers/dualsort.tex}.
