...
\bibitem{estelar} A.~M.~Lopes. \emph{O corpo estelar completo} (\code{papers/corpo\_analitico.tex}) ---
...
\bibitem{arquitetura} A.~M.~Lopes. \emph{A arquitetura} (\code{corpus/docs/arquitetura.tex}) --- a
