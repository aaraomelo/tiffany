...
\noindent \textbf{Primeiro, por quantos.} A pergunta mais crua que se pode fazer à Lei é
\emph{quantos}, e a resposta dá uma escada em que cada degrau produz uma estrutura --- e nenhuma
delas foi escolhida: cada uma é o que aquele número obriga.

\begin{center}\small
\begin{tabular}{@{}cll@{}}
\toprule
& \textbf{a unidade é\dots} & \textbf{e o que daí sai} \\
\midrule
$2$ & dual   & \textbf{a estaca} --- troca de lado, e é involutiva \\
$3$ & trial  & \textbf{o ponto fixo} --- dois lados e o sítio onde se trocam \\
$4$ & tetral & \textbf{a cruz, e o tempo} --- quatro réguas que fecham grupo \\
$5$ & \textbf{complexa} & \textbf{a geometria} --- o plano, a espiral, e $\varphi=2\cos(\pi/5)$ \\
\bottomrule
\end{tabular}
\end{center}
