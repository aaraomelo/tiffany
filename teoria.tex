...
Contração ela é: $96 \to 32$ bytes. Mas é uma contração \textbf{deliberadamente construída sem
dual} --- não há como esticar de volta, e é isso que ``unidirecional'' quer dizer. No catálogo, o
que não tem dual é o \textbf{decreto}, o absorvente. \emph{E isso não é defeito dela: é a razão de
a prova de trabalho existir} --- se tivesse dual, ninguém procuraria nonce nenhum, invertia-se.
\textbf{A ausência do dual é o trabalho.}
