...
\begin{center}
\textbf{\large A LEI --- a unidade é trial}
\medskip
...
\noindent \emph{Aquilo a que se chama uma unidade não é um objeto: são três.} Há o que afirma, há
o que nega, e há o que não faz nem uma coisa nem outra --- e os três são precisos, porque sem o
terceiro os dois primeiros não têm entre si nenhum sítio onde deixar de ser um e passar a ser o
outro.
