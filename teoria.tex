...
E o banco reporta a sua própria taxa: \textbf{1,15 MH/s} numa faixa limpa de dois milhões, num só
fio de execução. \emph{A taxa não se guarda} --- sai de duas leituras do relógio, como a distância
...
\textbf{E há uma fronteira exata, que a medida apanhou:} com comprimentos \emph{iguais},
$J^2 = I$ e as duas voltam com resíduo $0$; com comprimentos \emph{diferentes}, não --- a
alternância só se desfaz sozinha enquanto os dois lados tiverem símbolo, e quando um acaba o
desentrelaçar deixa de saber onde ela parou. \emph{Precisa do comprimento para inverter.}
...
sobrevive. E as duas são inclusões, logo as duas ordenam, logo as duas são réguas do mesmo corpo
$(0,-1)$: \textbf{morfar uma palavra é mudar de régua dentro dele, não sair dele.}
