...
\subsection{Reatância e capacitância saem do encaixe, e são as duas leis}\label{sec:entropia}
...
\item \textbf{A segunda lei é a direção, e é a reatância.} $\log N_n$ é estritamente crescente em $n$ sempre que
...
\begin{tabular}{@{}lll@{}}
\toprule
& \textbf{o que faz} & \textbf{na conta} \\
\midrule
\textbf{reatância} & opõe-se à mudança, acumula histórico & $\log N_n$ --- sobe com $n$ \\
\textbf{capacitância} & guarda por unidade, dá a taxa & $\log\sigma$ --- o passo \\
\bottomrule
\end{tabular}
\end{center}

\noindent \textbf{Reatância} é o que resiste ao que se quer fazer e cresce com o que já se fez ---
exatamente $\log N$, que só sobe e não tem inverso. \textbf{Capacitância} é quanto cabe por
unidade, que é a taxa a que a reatância cresce: $\log\sigma$. E as duas são duais no sentido
técnico do termo, não por semelhança --- \emph{uma é extensiva e a outra intensiva, uma acumula e a
outra é o ritmo da acumulação}, e derivar leva de uma à outra.

\medskip
\noindent \emph{É por isso que este texto prefere estes nomes.} Não é ornamento: entropia e
\emph{extropia} seriam um par inventado, com um dos lados sem existência própria; reatância e
capacitância são um par que a engenharia já usa há um século e que já vem com a dualidade
embutida. \textbf{Quando existe um par estabelecido, usá-lo é mais honesto do que criar um.} O que
...
\[
  [\text{capacitância}] = \log[\sigma], \qquad
