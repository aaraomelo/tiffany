...
\textbf{E o venom entrou no catálogo.} Ele também não tem $(B,C)$ inteiro --- o seu operador tem
valores próprios $(2^N, 2^{-N})$ com produto $1$, e matriz inteira com esse traço não existe. Mas
tem \textbf{duas leis medidas}, e são elas que dão a cifra, uma por lado do chicote: o lado próprio
é a lei \emph{aditiva} (cheio $+$ vazio constante, parabólico, $\sigma=1$) e o lado dual é a lei
\emph{multiplicativa} (células $\times$ volume constante, razão do nível $2^N=16$). O Wick vale
$1$: \emph{a lei aditiva fecha sozinha}.

\begin{verbatim}
  venom       (2 leis)   [1;1;1;1;16]

  30 corpos, 18 lugares distintos.   18 réguas distintas, matriz métrica.
  mais PERTO: criativo e venom, prefixo 4 — distância 1/16
\end{verbatim}

\textbf{E o vizinho mais próximo diz o que ele é.} O \code{criativo} --- a involução, o
\textsc{not} --- cifra $[1;1;1;1;1]$. O venom cifra $[1;1;1;1;16]$: \emph{partilham quatro termos e
diferem só no último}. Mesma forma, outra abertura --- o venom é a involução com a razão do nível
no lugar do $1$. E está a distância máxima do \code{hipercorpo}, que é a sua outra metade: um tem
Wick $1$, o outro $2$. \emph{A régua separou-os pelo lado que fecha}, sem lhe terem dito nada.
