...
\item \code{tools/poli.h} --- \textbf{a equação entre dois polinómios, $p(x)=q(x)$.} Passa-se
tudo para um lado, acham-se as raízes \emph{todas de uma vez} e substitui-se cada uma para medir
o resíduo. A resposta traz a \textbf{assinatura} $(r,s)$, que é a classificação do §G5 --- e em
