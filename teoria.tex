...
\subsection{A entropia sai do encaixe, e é a segunda lei}\label{sec:entropia}
...
\item \textbf{A segunda lei é a direção.} $\log N_n$ é estritamente crescente em $n$ sempre que
...
\noindent \textbf{$\log N$ é a entropia}, e não por analogia: é o logaritmo do número de estados
acessíveis, que é a definição. O que este teorema acrescenta é \emph{de onde ela vem} --- não é um
postulado sobre calor, é o que a contagem faz num encaixe que ramifica, e o seu dual é a medida,
que colapsa à mesma taxa.
