...
prefixo $0$ --- é a costura da curva, e nenhuma curva que enche o cubo lhe escapa. A cota vale de
um lado só.
...
\begin{verbatim}
  hipercorpo  (Hilbert)  [2;16;1;2;4;3;7;8;6;5;13;14;16;15;11;12;10;9]

  29 corpos, 17 lugares distintos.   17 réguas distintas.
\end{verbatim}
...
no meu texto como \emph{defeito} --- o erro de sempre: pegar metade da estrutura e chamar defeito à
outra metade.

\[\text{a ESPIRAL: onde } N \neq 0,\ \textbf{anda}\ ;\qquad
  \text{o CONE: onde } N = 0,\ \textbf{está}\]

Medido: $|N| = 1$ em toda a órbita do gato --- \emph{a espiral cresce mas a norma não se move} ---
e $N$ nunca é zero: \textbf{ela não toca o cone, orbita-o}. E o cone é \emph{irracional}: em
$801\times801$ pontos inteiros, nenhum lhe pertence. As suas direções têm declive $\sigma$ e
$-1/\sigma$, e $\sigma$ é irracional --- é por isso que o cone é \textbf{limite e não lugar}. A
espiral aproxima-se dele sem fim e nunca lá chega, que é exatamente a cifra $[1;1,1,1,\dots]$ a
convergir: \emph{o rei é esta aproximação; o cone é o que ele aproxima}.

\textbf{E o hipercorpo dualizado é isto mesmo.} Eu tinha escrito ``a recíproca é falsa: dois pontos
podem ser vizinhos no cubo e ter prefixo $0$ --- é a costura'', e arquivei-a como limitação.
\textbf{Não é: a costura é o cone nulo da curva.} É onde a distância da reta e a do cubo deixam de
concordar --- e a régua não \emph{falha} lá, ela \textbf{cinde} lá, como o corpo hiperbólico cinde
no seu cone.

\begin{verbatim}
  245760 pares vizinhos no cubo
  180225 deles NÃO são vizinhos na reta — a costura
  maior salto na reta entre vizinhos no cubo: 63351

  nível   travessias   previsto 15·16^k
  0       15           15
  1       240          240
  2       3840         3840
  3       61440        61440
...
\textbf{E a costura é auto-similar}: $15\cdot16^k$ em todos os níveis. Não é remendo do tamanho que
escolhi --- \emph{é o cone, e ele tem a mesma forma em toda a escala}. Duas previsões minhas caíram
aqui: escrevi o gato como $(a,b)\mapsto(a+b,a)$, que roda a forma em vez de a preservar (é
$(a,b)\mapsto(b,a+b)$, a multiplicação por $\sigma$), e previ \emph{uma} travessia no nível $0$
quando são \emph{quinze}.
