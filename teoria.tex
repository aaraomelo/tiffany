...
\medido{\code{tests/mobilidade.c} --- o experimento do tabuleiro: mover ao acaso sem nunca capturar. \textbf{A previsão de que a mobilidade zeraria em 2$ lances não se confirmou} --- mede-se 61$, e em parte das corridas o bloqueio nem chega a acontecer. E a mobilidade \emph{sobe} nos primeiros lances, de 0$ para 8$: as trinta e duas peças começam empilhadas e espalhar-se destapa-as. \emph{O que fica de pé} é o resto: quando o bloqueio acontece, as 2$ peças estão todas de pé, e há capturas disponíveis --- que são o único lance legal restante.}
