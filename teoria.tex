...
\begin{center}
\textbf{\large A LEI --- a unidade é inteira}
\medskip

$\mathbf{1} \;=\; \{\dots,-3,-2,-1,\;0,\;1,2,3,\dots\}$
\end{center}
\end{mdframed}

\noindent \emph{Aquilo a que se chama uma unidade não é um objeto: é uma escala inteira.} Há o que
afirma, há o que nega, há o que não faz nem uma coisa nem outra --- e há, para cada grau, um que
afirma \emph{tanto} e um que nega \emph{outro tanto}.

\medskip
\noindent \textbf{O núcleo é trial.} Os três primeiros graus, $\{-1,0,+1\}$, são o mínimo que
opera, e é sobre eles que se prova tudo o que se segue; mas a Lei não pára neles, e é do resto da
escala que sai a família inteira dos corpos.
...
\noindent \emph{E a ordem em que aparecem no livro não é a ordem desta tabela}, por uma razão que
vale a pena dizer: escreve-se primeiro o que se opera (a Álgebra), porque sem operação não há o que
...
\medskip
\noindent \emph{Nota sobre a numeração, e é a última que este texto faz.} Não há cinco leis: há uma
Lei e cinco faces. As duas que este volume prova --- \emph{a unidade é dual} e \emph{a dualidade é
...
\medskip
\noindent \emph{Uma ressalva, e é de método.} Nada nisto é uma afirmação sobre o universo físico:
...
\medskip
\noindent \emph{Uma nota de honestidade, e fica no corpo:} este sistema é \textbf{fechado} --- cada
...
\medskip
\noindent \emph{E agora a ressalva, que é a parte séria.} Nada disto é uma afirmação sobre a
