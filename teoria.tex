...
$5$ & --- & \textbf{o ouro} --- $\varphi=2\cos(\pi/5)$, a primeira borda irracional \\
\bottomrule
\end{tabular}
\end{center}
...
troca; o quarto dá as quatro leituras, que fecham grupo, e é delas que sai o tempo. E ao quinto a
escada deixa de fechar em inteiros: $2\cos(\pi/5)$ é irracional, e é o primeiro grau em que a
unidade já não se conta --- \textbf{é onde a interpretação passa de \emph{quantos} para
\emph{quanto}}.
...
\part{A unidade é dual --- o que fecha a volta}
