...
o que não se deriva & Maxwell, continuidade, $\partial$, vácuo, dimensão três & \texttt{fis:em-naoderiva} \\
\bottomrule
\end{tabular}
\end{center}
...
\item \textbf{Maxwell e as equações de campo não entram.} Nada na construção de
      ...
      transporte. O cruzado da leitura tipada (os marginais) é soma exacta de
      contagens, não um termo de acoplamento vectorial.
