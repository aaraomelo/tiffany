...
\ifSubfilesClassLoaded{%
  \gkcapa{A Física Araniana}
         ...
         {álgebra, topologia, análise, geometria, mecânica, óptica, partículas e núcleo,
          cosmologia, redes --- nove lugares, um sistema}
  \maketitle
  \tableofcontents
}{%
...
opera em \textbf{nove} lugares, e é por eles que ela se reparte aqui. A
...
\medskip\noindent E os três últimos lugares são o mesmo sistema em três escalas.
As \textbf{partículas e o núcleo}: o átomo como cadeia espectral, a massa como
distância ao círculo, a ligação como folga, e o mapa espectral que diz que
átomos a álgebra permite. A \textbf{cosmologia}: a taxa como a régua invertida,
os conteúdos como os três valores do trial, e o universo como uma órbita. E as
