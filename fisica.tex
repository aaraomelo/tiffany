...
%
%  O QUE ESTE FICHEIRO É: a matéria da aranha estigmérgica ORGANIZADA nos dez
%  lugares onde ela opera — álgebra, topologia, análise, geometria, mecânica,
%  óptica, partículas e núcleo, termodinâmica, cosmologia, redes. Nada foi
...
\colunas{Teor.~\ref{fis:thm:taxa},~\ref{fis:thm:conteudos},~\ref{fis:thm:diluicao},~\ref{fis:thm:bidual},~\ref{fis:thm:conica}; Cor.~\ref{fis:cor:destino},~\ref{fis:cor:destino-orbita}}        {$H^{2}=1/D$; os três conteúdos no trial; a diluição com a sua constante; a órbita de quatro}
