/*
 * micro_tb.sv - teste de equivalencia do RTL (V01..V10)
 *
 * Oraculo: vectors_isa.c (micro.c)
 * Alvo:    micro.sv
 *
 * Cada vetor carrega o MESMO programa, o MESMO estado inicial e confere:
 *   resultado em word[raddr], pc final, steps (inclui HALT), halted.
 *
 * Compilar / rodar:
...
module micro_tb;
    ...
    /* ==================================================================
     * V01..V10 - mesma imagem de programa, mesmo estado inicial que
     * vectors_isa.c (encodings little-endian de encode80).
     * ================================================================== */
    initial begin
        $display("=== micro.sv vs oraculo micro.c (V01..V10) ===");
        $display("");
        ...
        $display("");
        if (nfail == 0)
            $display("[OK] 10 vetores - micro.sv reproduz o oraculo micro.c (resid 0)");
        else
